...
namespace BDMusica{
    public class BaseDeDatos{
        ...
        public int obtenerInsertarAlbum(string albumName, string path, int year){
        ...
        public int obtenerInsertarArtista(string performerName){
        ...
        public void insertarCancion(int performerId, int albumId, string path, string title, int track, int year, string genre){
            string insertRolaSql = @"
            ...
            using (var command = new SQLiteCommand(insertRolaSql, connection)){
